...
void Interface::setup()
{
	...
	Input* newInput = new Input(coord, "fonts/verdana.ttf", 12, LEFT_ALIGN);

	Inputs.push_back(newInput);

	SDL_Rect mainList1 = { 520, 240, 160, 20 };
	SDL_Rect item1 = { -1, -1, 160, 20 };
	DropDownList* DropDownList2 = new DropDownList(mainList1, item1, LEFT_SIDE, "fonts/verdana.ttf", 12, LEFT_ALIGN);
	...
	ItemList* itemList1 = new ItemList(itemListRect1, itemList_ItemRect, "String", "fonts/verdana.ttf", 12, LEFT_ALIGN);
